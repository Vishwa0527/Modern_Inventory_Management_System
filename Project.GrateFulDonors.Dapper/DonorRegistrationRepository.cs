...
namespace Project.GrateFulDonors.Dapper
{
    public static class DonorRegistrationRepository
    {
        ...
        //public static DynamicParameters MapToFarmerDocumentDetails(FarmerDocumentSaveModel model, string filePath, string fileLink, int CreatedBy, int farmerID)
        //{
        //    DynamicParameters dynamicParameters = new DynamicParameters();
        //    dynamicParameters.Add("FarmerDocumentID", 0.ToString(), DbType.Int32, ParameterDirection.Output);
        //    dynamicParameters.Add("FarmerID", farmerID.ToString(), DbType.Int32, ParameterDirection.Input);
        ...
        //    dynamicParameters.Add("CreatedBy", CreatedBy.ToString(), DbType.Int32, ParameterDirection.Input);
